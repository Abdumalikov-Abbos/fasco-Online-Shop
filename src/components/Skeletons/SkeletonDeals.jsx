...
const DealsOfTheMonthSkeleton = (props) => (
  ...
  >
    ...
    <rect x="30" y="30" rx="4" ry="4" width="250" height="30" />{" "}
    {/* Sarlavha */}
    <rect x="30" y="70" rx="3" ry="3" width="280" height="20" />{" "}
    {/* Paragraf */}
    <rect x="30" y="100" rx="3" ry="3" width="220" height="20" />
    <rect x="30" y="140" rx="6" ry="6" width="100" height="35" />{" "}
    {/* Buy Now button */}
    {/* Taymer (sanagich) */}
    <rect x="30" y="200" rx="4" ry="4" width="200" height="20" />{" "}
    {/* Hurry... */}
    ...
    <rect x="350" y="30" rx="10" ry="10" width="180" height="300" />{" "}
    {/* Rasm 1 */}
    <rect x="540" y="30" rx="10" ry="10" width="180" height="300" />{" "}
    {/* Rasm 2 */}
    <rect x="730" y="30" rx="10" ry="10" width="180" height="300" />{" "}
    {/* Rasm 3 */}
    {/* Slayder tugmalari */}
