  ...
  const products = [
    {
      ...
      price: 8,
      size: ["S", "M"],
      colors: ["bg-lemon", "bg-black", "bg-teaGreen"],
      items: 14,
    },
    {
      id: 2,
      ...
      price: 17,
      size: ["S", "M", "XL"],
      colors: ["bg-CoolBlue", "bg-pastelPink", "bg-powderGray"],
      items: 26,
    },
    {
      id: 3,
      ...
      price: 106,
      size: ["XL"],
      colors: ["bg-beige", "bg-teaGreen", "bg-navyBlue"],
      items: 65,
    },
    {
      id: 4,
      ...
      price: 25,
      size: ["M"],
      colors: ["bg-powderGray", "bg-navyBlue", "bg-coffee"],
      items: 23,
    },
    {
      id: 5,
      ...
      price: 55,
      size: ["S", "L"],
      colors: ["bg-teaGreen", "bg-black", "bg-softCyan"],
      items: 356,
    },
    {
      id: 6,
      ...
      price: 11,
      size: ["S", "M"],
      colors: ["bg-black", "bg-softCyan", "bg-pinkRed"],
      items: 92,
    },
    {
      id: 7,
      ...
      price: 18,
      size: ["S", "M", "XL"],
      colors: ["bg-black", "bg-coffee", "bg-powderGray"],
      items: 52,
    },
    {
      id: 8,
      ...
      price: 150,
      size: ["S", "M", "L", "XL"],
      colors: ["bg-pastelPink", "bg-softCyan", "bg-black"],
      items: 128,
    },
    {
      id: 9,
      ...
      price: 20,
      size: ["M", "L", "XL"],
      colors: ["bg-navyBlue", "bg-black", "bg-softCyan"],
      items: 5,
    },
  ];
    ...
    <>
      <div className="pt-[52px] max-w-fasco-container mx-auto">
        <div className="flex justify-between items-center flex-wrap md:flex-nowrap">
          <div className="pl-8">
            <h3
              className="text-5xl volkhov-bold cursor-pointer"
              onClick={() => navigate("/")}
            >
              FASCO
            </h3>
      ...
      <div className="flex max-w-fasco-container mx-auto flex-wrap">
        ...
        <div className="w-full md:w-3/4 pl-14 mt-[98px]">
          <div
            className={
              page === 1
                ? "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 pt-6"
                : "hidden"
            }
          >
