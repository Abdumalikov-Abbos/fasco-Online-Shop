    ...
    <div className="max-w-fasco-container mx-auto px-4 py-16  relative">
      ...
      >
        {testimonials.map((testimonial) => (
          <SwiperSlide key={testimonial.id} className="!w-[80%] md:!w-[60%] lg:!w-[40%] mb-[10px]">
            <div className="bg-white w-[650px]   h-[300px] p-8 rounded-lg shadow-md text-center transition-all duration-300 swiper-slide-content flex items-center justify-between space-x-6">
              ...
              <p className="text-[#484848] font-[400] text-[16px] leading-[160%]">"{testimonial.text}"</p>
               <Stars rating={testimonial.rating} className="mt-[27px]" />
               <div className="border border-[#484848] w-[230px] h-[1px] mt-[30px]">

               </div>
               <p className="font-[400] text-[32px] text-[#484848] leading-[100%] mt-[15px]">{testimonial.name}</p>
               <p className="text-[16px] font-[400] text-[#484848] mt-[13px]">{testimonial.role}</p>
             </div>
            </div>
          </SwiperSlide>
        ))}
